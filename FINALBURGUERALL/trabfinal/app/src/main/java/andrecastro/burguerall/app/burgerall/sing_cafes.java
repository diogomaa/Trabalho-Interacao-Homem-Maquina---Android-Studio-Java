 ...
 */
public class sing_cafes extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lista.add(new itemsingular(R.drawable.cafe, "Cafe Curto", 1));
        lista.add(new itemsingular(R.drawable.cafe, "Cafe Longo", 1.5));
        lista.add(new itemsingular(R.drawable.cafe, "Descafenado", 1));
        lista.add(new itemsingular(R.drawable.cafe, "Chocolate Quente", 1));
