 ...
 */
public class sing_bebidas extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lista.add(new itemsingular(R.drawable.coca, "CocaCola", 1));
        lista.add(new itemsingular(R.drawable.fanta, "Fanta", 1));
        lista.add(new itemsingular(R.drawable.lipton, "Ice Tea", 1));
        lista.add(new itemsingular(R.drawable.agua, "Água", 0.5));
