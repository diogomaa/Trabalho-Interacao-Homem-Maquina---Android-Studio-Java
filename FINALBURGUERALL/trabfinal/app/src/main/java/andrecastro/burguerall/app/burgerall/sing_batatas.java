 ...
 */
public class sing_batatas extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lista.add(new itemsingular(R.drawable.pequenas, "Batata Pequenas", 1));
        lista.add(new itemsingular(R.drawable.medias, "Batata Médias", 1.8));
        lista.add(new itemsingular(R.drawable.grandes, "Batatas Grandes", 2.5));
        lista.add(new itemsingular(R.drawable.caseiras, "Batats Caseiras", 2));
